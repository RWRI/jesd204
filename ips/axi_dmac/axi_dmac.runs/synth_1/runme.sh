...
HD_PWD='C:/GitHub/jesd204/ips/axi_dmac/axi_dmac.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_dmac.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_dmac.tcl
