...
HD_PWD='C:/GitHub/jesd204/ips/util_do_ram/util_do_ram.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log util_do_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source util_do_ram.tcl
