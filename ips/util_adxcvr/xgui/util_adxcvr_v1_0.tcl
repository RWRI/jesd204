...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "PPF1_CFG" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "RXDFE_KH_CFG2" -parent ${Page_0}
  ipgui::add_param $IPINST -name "RXDFE_KH_CFG3" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "RX_LANE_RATE" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "TXFE_CFG0" -parent ${Page_0}
...
proc update_PARAM_VALUE.CH_HSPMUX { PARAM_VALUE.CH_HSPMUX } {
...
proc update_PARAM_VALUE.PPF1_CFG { PARAM_VALUE.PPF1_CFG } {
	# Procedure called to update PPF1_CFG when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.PPF1_CFG { PARAM_VALUE.PPF1_CFG } {
	# Procedure called to validate PPF1_CFG
	return true
}
...
proc update_PARAM_VALUE.RTX_BUF_CML_CTRL { PARAM_VALUE.RTX_BUF_CML_CTRL } {
...
proc update_PARAM_VALUE.RXCDR_CFG3_GEN2 { PARAM_VALUE.RXCDR_CFG3_GEN2 } {
...
proc update_PARAM_VALUE.RXCDR_CFG3_GEN4 { PARAM_VALUE.RXCDR_CFG3_GEN4 } {
...
proc update_PARAM_VALUE.RXDFE_KH_CFG2 { PARAM_VALUE.RXDFE_KH_CFG2 } {
	# Procedure called to update RXDFE_KH_CFG2 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.RXDFE_KH_CFG2 { PARAM_VALUE.RXDFE_KH_CFG2 } {
	# Procedure called to validate RXDFE_KH_CFG2
	return true
}

proc update_PARAM_VALUE.RXDFE_KH_CFG3 { PARAM_VALUE.RXDFE_KH_CFG3 } {
	# Procedure called to update RXDFE_KH_CFG3 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.RXDFE_KH_CFG3 { PARAM_VALUE.RXDFE_KH_CFG3 } {
	# Procedure called to validate RXDFE_KH_CFG3
	return true
}

proc update_PARAM_VALUE.RXPI_CFG0 { PARAM_VALUE.RXPI_CFG0 } {
...
proc update_PARAM_VALUE.RXPI_CFG1 { PARAM_VALUE.RXPI_CFG1 } {
...
proc update_PARAM_VALUE.RX_LANE_RATE { PARAM_VALUE.RX_LANE_RATE } {
	# Procedure called to update RX_LANE_RATE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.RX_LANE_RATE { PARAM_VALUE.RX_LANE_RATE } {
	# Procedure called to validate RX_LANE_RATE
	return true
}
...
proc update_PARAM_VALUE.TXFE_CFG0 { PARAM_VALUE.TXFE_CFG0 } {
	# Procedure called to update TXFE_CFG0 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.TXFE_CFG0 { PARAM_VALUE.TXFE_CFG0 } {
	# Procedure called to validate TXFE_CFG0
	return true
}
...
proc update_PARAM_VALUE.TXSWBST_EN { PARAM_VALUE.TXSWBST_EN } {
	# Procedure called to update TXSWBST_EN when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.TXSWBST_EN { PARAM_VALUE.TXSWBST_EN } {
	# Procedure called to validate TXSWBST_EN
	return true
}
...
proc update_PARAM_VALUE.TX_LANE_RATE { PARAM_VALUE.TX_LANE_RATE } {
	# Procedure called to update TX_LANE_RATE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.TX_LANE_RATE { PARAM_VALUE.TX_LANE_RATE } {
	# Procedure called to validate TX_LANE_RATE
	return true
}
...
proc update_MODELPARAM_VALUE.RX_LANE_RATE { MODELPARAM_VALUE.RX_LANE_RATE PARAM_VALUE.RX_LANE_RATE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.RX_LANE_RATE}] ${MODELPARAM_VALUE.RX_LANE_RATE}
}

proc update_MODELPARAM_VALUE.TX_LANE_RATE { MODELPARAM_VALUE.TX_LANE_RATE PARAM_VALUE.TX_LANE_RATE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.TX_LANE_RATE}] ${MODELPARAM_VALUE.TX_LANE_RATE}
}
...
proc update_MODELPARAM_VALUE.PPF1_CFG { MODELPARAM_VALUE.PPF1_CFG PARAM_VALUE.PPF1_CFG } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.PPF1_CFG}] ${MODELPARAM_VALUE.PPF1_CFG}
}
...
proc update_MODELPARAM_VALUE.RXDFE_KH_CFG2 { MODELPARAM_VALUE.RXDFE_KH_CFG2 PARAM_VALUE.RXDFE_KH_CFG2 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.RXDFE_KH_CFG2}] ${MODELPARAM_VALUE.RXDFE_KH_CFG2}
}

proc update_MODELPARAM_VALUE.RXDFE_KH_CFG3 { MODELPARAM_VALUE.RXDFE_KH_CFG3 PARAM_VALUE.RXDFE_KH_CFG3 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.RXDFE_KH_CFG3}] ${MODELPARAM_VALUE.RXDFE_KH_CFG3}
}
...
proc update_MODELPARAM_VALUE.TXFE_CFG0 { MODELPARAM_VALUE.TXFE_CFG0 PARAM_VALUE.TXFE_CFG0 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.TXFE_CFG0}] ${MODELPARAM_VALUE.TXFE_CFG0}
}
...
proc update_MODELPARAM_VALUE.TXSWBST_EN { MODELPARAM_VALUE.TXSWBST_EN PARAM_VALUE.TXSWBST_EN } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.TXSWBST_EN}] ${MODELPARAM_VALUE.TXSWBST_EN}
}
