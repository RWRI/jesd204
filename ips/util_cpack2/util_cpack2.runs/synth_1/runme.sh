...
HD_PWD='C:/GitHub/jesd204/ips/util_cpack2/util_cpack2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log util_cpack2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source util_cpack2.tcl
