...
HD_PWD='C:/GitHub/jesd204/ips/util_upack2/util_upack2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log util_upack2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source util_upack2.tcl
