...
HD_PWD='C:/GitHub/jesd204/ips/data_offload/data_offload.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log data_offload.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source data_offload.tcl
