...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "DATAPATH_DISABLE" -parent ${Page_0}
  ipgui::add_param $IPINST -name "DDS_CORDIC_DW" -parent ${Page_0}
  ipgui::add_param $IPINST -name "DDS_CORDIC_PHASE_DW" -parent ${Page_0}
  ipgui::add_param $IPINST -name "DDS_PHASE_DW" -parent ${Page_0}
  ipgui::add_param $IPINST -name "DDS_TYPE" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "IQCORRECTION_DISABLE" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "XBAR_ENABLE" -parent ${Page_0}
...
proc update_PARAM_VALUE.DDS_CORDIC_DW { PARAM_VALUE.DDS_CORDIC_DW } {
...
proc update_PARAM_VALUE.DDS_CORDIC_PHASE_DW { PARAM_VALUE.DDS_CORDIC_PHASE_DW } {
...
proc update_PARAM_VALUE.DDS_PHASE_DW { PARAM_VALUE.DDS_PHASE_DW } {
	# Procedure called to update DDS_PHASE_DW when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.DDS_PHASE_DW { PARAM_VALUE.DDS_PHASE_DW } {
	# Procedure called to validate DDS_PHASE_DW
	return true
}

proc update_PARAM_VALUE.DDS_TYPE { PARAM_VALUE.DDS_TYPE } {
...
proc update_PARAM_VALUE.XBAR_ENABLE { PARAM_VALUE.XBAR_ENABLE } {
	# Procedure called to update XBAR_ENABLE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.XBAR_ENABLE { PARAM_VALUE.XBAR_ENABLE } {
	# Procedure called to validate XBAR_ENABLE
	return true
}
...
proc update_MODELPARAM_VALUE.DDS_PHASE_DW { MODELPARAM_VALUE.DDS_PHASE_DW PARAM_VALUE.DDS_PHASE_DW } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.DDS_PHASE_DW}] ${MODELPARAM_VALUE.DDS_PHASE_DW}
}
...
proc update_MODELPARAM_VALUE.XBAR_ENABLE { MODELPARAM_VALUE.XBAR_ENABLE PARAM_VALUE.XBAR_ENABLE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.XBAR_ENABLE}] ${MODELPARAM_VALUE.XBAR_ENABLE}
}
