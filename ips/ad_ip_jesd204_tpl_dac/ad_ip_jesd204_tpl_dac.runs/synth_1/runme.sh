...
HD_PWD='C:/GitHub/jesd204/ips/ad_ip_jesd204_tpl_dac/ad_ip_jesd204_tpl_dac.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ad_ip_jesd204_tpl_dac.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ad_ip_jesd204_tpl_dac.tcl
