...
HD_PWD='C:/GitHub/jesd204/layers/axi_ad9144_jesd/axi_ad9144_jesd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_ad9144_jesd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_ad9144_jesd_wrapper.tcl
