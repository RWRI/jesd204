...
HD_PWD='C:/GitHub/jesd204/layers/phy_shared/phy_shared.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log phy_shared_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source phy_shared_wrapper.tcl
