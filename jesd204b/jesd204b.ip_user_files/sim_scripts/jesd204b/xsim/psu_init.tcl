...
set psu_clock_init_data {
    ...
    # usually an issue, but designers must be aware.)
		# PSU_CRF_APB_ACPU_CTRL_SRCSEL                                                    0x2
    ...
    # d ACPUX Clock. This will shut off the high speed clock to the entire APU
		...
		# This register controls this reference clock
		#(OFFSET, MASK, VALUE)      (0XFD1A0060, 0x03003F07U ,0x03000102U)  */
    mask_write 0XFD1A0060 0x03003F07 0x03000102
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180134 0x000000FE 0x00000060
		...
		#(OFFSET, MASK, VALUE)      (0XFF180204, 0xFFFFFFFFU ,0x00000240U)  */
    mask_write 0XFF180204 0xFFFFFFFF 0x00000240
		...
		#(OFFSET, MASK, VALUE)      (0XFF180208, 0x000FFFFFU ,0x0000303FU)  */
    mask_write 0XFF180208 0x000FFFFF 0x0000303F
		...
		#(OFFSET, MASK, VALUE)      (0XFF18020C, 0x00003000U ,0x00000000U)  */
    mask_write 0XFF18020C 0x00003000 0x00000000
